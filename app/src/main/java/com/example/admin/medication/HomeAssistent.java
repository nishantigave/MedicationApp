...
public class HomeAssistent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_assistent);
        listView = (ListView) findViewById(R.id.LV1);
        itemArrayAdapter = new ItemArrayAdapter(getApplicationContext(), R.layout.activity_home_assistent);
